...
## sequence database
my $NCBI_DIR = "/genetics/PAREG/common/Protease_Data/ncbi-blast-2.7.1+/bin/";
my $SEQ_DB = "/genetics/PAREG/common/Protease_Data/ncbi-blast-2.7.1+/db/uniref90_blastPlus";
...
my $args = join ' ', $NCBI_DIR."psiblast", "-db", $SEQ_DB, "-query", $fasta_fn, "-inclusion_ethresh", "0.001", "-num_threads", $NUM_THREADS, "-out_pssm", $chk_file, "-num_iterations", "3", "-num_alignments", "0", ">&", $hits_file;
